...
<h1 class="text-center">Add Exam Time Table </h1>
<br>
         <div class="row"> 
...
<div class="form-group row">
  ...
  <h1 class="text-right">
         ...
         <div class="col-12">
         <a href="examtimetable.php" button type="button" class="btn btn-success"  aria-pressed="true" >Back</button>

    ...
    <div class="col-sm-3">
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              <button class="btn btn-outline-primary" type="button" id="button-addon2">Search ID</button>
            </div>
          </div>
    </div>
</div>
...
<div class="col-sm-4">
    <table class="table table-sm">
        ...
        <br>
        <h2>
        <button type="button" class="btn btn-primary btn-block"><h1><i class="fab fa-amazon-pay"></i>&nbsp;
        </button> </h1>

 ...
 <table class="table table-hover table-light">
  <thead>
    <tr>
      ...
      <th scope="col" class="bg-primary"><i class="far fa-envelope">..</i>Comments</th>
      <th scope="col" class="bg-primary">Want Salary</th>
      <th scope="col" class="bg-primary">Accept</th>
      <th scope="col" class="bg-primary">Not Accept</th>
  ...
  <tbody>
    <tr>
      ...
      <td></td>
      <td></td>
      <td><button type="button" class="btn btn-outline-success">YES</button></td>
      <td><button type="button" class="btn btn-outline-danger">NO</button></td>
    </tr>
    <tr>
    <td></td>
      <td></td>

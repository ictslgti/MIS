...
<form method="post" action="">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12"><?php echo '<h4 class="text-danger">' .  $s_edate . '</h4>'; ?></div>   
                    ...
                    <h2  class="pt-2">Feedback Survey Summery <i class="far fa-frown"></i>&nbsp;&nbsp;<i class="far fa-flushed"></i>&nbsp;&nbsp;<i class="far fa-frown-open"></i> </h2>
                    </div>
                        ...
                        <div class="row border-bottom  mb-4 " >
                            ...
                            <div class="col-md-2 col-sm-12">
                                ...
                                <?php
                                    ...
                                    ?>
                                       <label class="text-danger" data-toggle="tooltip" data-placement="top" title="Average" > <?php echo  $TotalCount; ?> %</label>
                                </div>
                            </div>
                        ...
                        <div class="row border-bottom  mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q2f; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q2g; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q2h; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q2i; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q2j; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q3k; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q3l; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q3m; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q3n; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q3o; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4" >
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q4p; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q4q; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q4r; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q4s; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q4t; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q5u; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q5x; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q5y; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q5z; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q5aa; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q6ab; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q6ac; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q6ad; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q6ae; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q6af; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q7ag; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q7ah; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q7ai; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q7aj; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q7ak; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q8al; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q8am; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q8an; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q8ao; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q8ap; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q9aq; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q9ar; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q9as; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q9at; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q9au; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom  mb-4 " >
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q10ax; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q10ay; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q10az; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q10ba; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q10bb; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom  mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q11bc; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q11bd; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q11be; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q11bf; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q11bg; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q12bh; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q12bi; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>    
                                    <label class="" >3 <?php echo  $f_q12bj; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q12bk; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q12bl; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q13bm; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q13bn; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q13bo; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q13bp; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q13bq; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q14br; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q14bs; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q14bt; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q14bu; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q14bx; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q15by; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q15bz; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q15aaa; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q15aab; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q15aac; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q16aad; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q16aae; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q16aaf; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q16aag; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q16aah; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q17a; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q17b; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q17c; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q17d; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q17e; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">
                        ...
                        <div class="row border-bottom mb-4 ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                        <label class="" >1 <?php echo  $f_q18a; ?></label>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >2 <?php echo  $f_q18b; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                    <label class="" >3 <?php echo  $f_q18c; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >4 <?php echo  $f_q18d; ?></label>
                                </div>
                                ...
                                <div class="custom-control-inline">
                                    ...
                                    ?>
                                          <label class="" >5 <?php echo  $f_q18e; ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="custom-control-inline">

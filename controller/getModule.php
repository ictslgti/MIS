...
if(isset($_POST['semister'])){
    $id = $_POST['semister'];
    echo '<option value="null"  selected disabled>--Select Module--</option>';
    echo '<option value="M1">semester '.$id.' Module 1</option>';
    echo '<option value="M2">semester '.$id.' Module 2</option>';
    echo '<option value="M3">semester '.$id.' Module 3</option>';
    echo '<option value="M4">semester '.$id.' Module 4</option>';
    echo '<option value="M5">semester '.$id.' Module 5</option>';

...
<?php
 ...
 $StudentID=$Department_id=$StudentName=$DepartmentName=$PNO=$Email=$Finalplace=$Address=null;
...
<?php
  if(isset($_GET['edit'])){
        $StudentID=$_GET['edit'];
        $sql="SELECT `student_id`, `student_name`, `phone_no`, `e_mail`, `department_name`, `final_place`, `final_address` FROM `ojt` WHERE `student_id`='$StudentID'";

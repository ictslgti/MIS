          ...
          //if any button clicked get the button value in a variable 
               if(isset($_POST['id'])){
                    ...
                    $postchar = $postchar*10;                 
                     $query ="SELECT assessments_marks.assessment_marks_id,assessments_marks.assessment_id,assessments_marks.student_id,assessments_marks.assessment_attempt,assessments_marks.assessment_marks,assessments_marks.assessment_marks_grade FROM assessments_marks ASC LIMIT 10 OFFSET $postchar";
                }
               else{ 
                    $query = "SELECT assessment_marks_id,assessment_id,student_id,assessment_attempt,assessment_marks,assessment_marks_grade FROM assessments_marks LIMIT 10 OFFSET 0"; 
                }  

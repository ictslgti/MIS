...
<!--END DON'T CHANGE THE ORDER-->
    ...
    <div class="row pl-5 pt-5">
            ...
            <div class="col-md-4 col-sm-12 pl-5 ">
                <a  href="Notice Timetable.php" style="text-decoration:none">
        ...
        <div class="col-md-4 col-sm-12 pl-5 ">
        <a  href="Notice Result.php" style="text-decoration:none">
            ...
            <div class="card text-white bg-success mb-3 mt-5" style="max-width: 18rem;">
                 <div class="card-header"><h3>EVENTS</h3></div>
                         ...
                         <div class="list-group">
                                <a href="Notice Event View.php" class="list-group-item list-group-item-action list-group-item-primary">Awarding Ceremoney</a>
